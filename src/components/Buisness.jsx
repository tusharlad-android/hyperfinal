...
const Buisness = () =>(
  ...
  <img src={strategy} className='w-16 h-16 mb-5'/>
  ...
  <div className="w-full sm:w-1/2 md:w-1/3  p-4 ">
  <div className="border p-4 rounded-[20px] text-center flex flex-col items-center justify-center h-full aspect-w-1 aspect-h-1  feature-card">
  <img src={branding} className='w-16 h-16 mb-5'/>
  ...
  <div className="w-full sm:w-1/2 md:w-1/3  p-4 ">
  <div className="border p-4 rounded-[20px] text-center flex flex-col items-center justify-center h-full aspect-w-1 aspect-h-1  feature-card">
    <img src={content} className='w-16 h-16 mb-5'/>
  ...
  <div className="w-full sm:w-1/2 md:w-1/3  p-4 ">
  <div className="border p-4 rounded-[20px] text-center flex flex-col items-center justify-center h-full aspect-w-1 aspect-h-1  feature-card">
  <img src={design} className='w-16 h-16 mb-5'/>
  ...
  <div className="border p-4 rounded-[20px] text-center flex flex-col items-center justify-center h-full aspect-w-1 aspect-h-1  feature-card">
  <img src={marketing} className='w-16 h-16 mb-5'/>
  ...
  <div className="w-full sm:w-1/2 md:w-1/3  p-4 ">
  <div className="border p-4 rounded-[20px] text-center flex flex-col items-center justify-center h-full aspect-w-1 aspect-h-1 feature-card">
  <img src={technology} className='w-16 h-16 mb-5'/>
